        ...
        <div v-if="paginatedNotices.length">
          <div class="input-base list-wrapper" v-for="notice in paginatedNotices" :key="notice.notice_board_no" @click="handleNoticeClick(notice)">
              <div class="notice-details">
                ...
                <i :class="['bi', isPostLiked(loginInfo.user_no, notice.notice_board_no) ? 'bi-heart-fill' : 'bi-heart']"
                :style="{ color: isPostLiked(loginInfo.user_no, notice.notice_board_no) ? '#dc3545' : 'inherit' }"></i>
