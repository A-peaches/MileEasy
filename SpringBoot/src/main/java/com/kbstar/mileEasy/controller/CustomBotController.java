...
public class CustomBotController {
    ...
    public String Postchat(@RequestParam(name = "prompt") String prompt,
        ...
        assert chatGPTResponse != null;
        aiReportService.saveChat(user_no, chatGPTResponse.getChoices().get(0).getMessage().getContent(), myScoreJson, avgScoreJson, String.valueOf(percentageScore));
        return chatGPTResponse.getChoices().get(0).getMessage().getContent();
    }
    ...
    public String chatMile(@RequestParam(name = "prompt") String prompt,
        ...
        ArrayList<group_weight
                > groupWeight = aiReportService.group_weight(user_no);


        ArrayList<group_weight_avg> groupWeightAvg = aiReportService.group_weight_avg(myGroup.get(0).getGroup_no());
        ArrayList<my_weight_avg> myWeightAvg = aiReportService.my_weight_avg(user_no, myGroup.get(0).getGroup_no());
